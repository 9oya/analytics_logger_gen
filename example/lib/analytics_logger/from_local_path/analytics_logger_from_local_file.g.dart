...
part of 'analytics_logger_from_local_file.dart';
...
class AnalyticsEventsProvider {
  ...
  static void appStarted() {
    ...
    CustomAnalyticsLoggerC.logEvent(AnalyticsEvents.appStarted, attributes);
  }
  ...
  static void homePageEntered({dynamic abTestCase}) {
    ...
    CustomAnalyticsLoggerC.logEvent(
  ...
  static void myPageEntered({dynamic abTestCase}) {
    ...
    CustomAnalyticsLoggerC.logEvent(AnalyticsEvents.myPageEntered, attributes);
  }

  static void appEnded() {
    Map<String, dynamic> attributes = <String, dynamic>{};
    CustomAnalyticsLoggerC.logEvent(AnalyticsEvents.appEnded, attributes);
  }
  ...
  static void selectContents({dynamic contentType, dynamic itemId}) {
    ...
    CustomAnalyticsLoggerC.logEvent(AnalyticsEvents.selectContents, attributes);
  }
...
class CustomAnalyticsLoggerC {
  CustomAnalyticsLoggerC._();
